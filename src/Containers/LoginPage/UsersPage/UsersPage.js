        ...
        <div class="user-list-pageWrapper">
            ...
            <div class="user-list-order-wrapper">
                ...
                <form class="user-list-filterWrapper">
                    <input class="user-list-search-box" type="text" id="myInput"   placeholder="Search by Name" />
                    <input type="reset" id="null-btn" class="user-list-button" value="Reset" />
                </form>
                
                
                <div>
                    <table class="user-list">
                        <tr><th>ID</th><th>User Avatar</th><th>Full Name</th><th>DoB</th><th>Gender</th><th>Current Location</th></tr>
